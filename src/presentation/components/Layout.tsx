...
export function Layout() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-bg text-ink print:bg-transparent">
      {/* Ambient glow — fixed layers stamp every printed page, so drop them at print */}
