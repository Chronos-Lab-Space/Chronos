    ...
    <section className="rounded-2xl border border-chronos/30 bg-gradient-to-br from-chronos/10 via-bg to-bg p-5 sm:p-6">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-2 text-sm text-ink-dim">
            Unlock Chronos by deciding — not by reading a tutorial. Chronos recommends; you save the
            path.
          </p>
        </div>
      ...
      <p className="mt-4 rounded-xl border border-line/80 bg-bg/50 px-3 py-2.5 text-[12px] leading-relaxed text-ink-dim">
        ...
        <span className="mt-1 block">
          Decision → knowledge → run sim → review report → save path → log outcome. Prefer
